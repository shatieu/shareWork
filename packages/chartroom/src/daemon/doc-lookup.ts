...
/**
 * The doc "key" convention shared with the UI (v1.1 API contract): a doc is addressed by
...
/**
 * Resolve a route's `:docId` param to a doc, by the strict two-step lookup order (v1.1 contract):
 *
