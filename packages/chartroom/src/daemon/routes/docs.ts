...
export interface DocDetailResponse {
  /** frontmatter id, or null for an unidentified (id-less) doc -- wave-2 contract. */
  id: string | null;
 ...
 * + raw content + backlinks + brokenLinks filtered to that doc's path) -- plan §4.1. Since wave 2,
